//gonf package read the config file from location
...
//override env field name
const envTag = "env"

func GetConfig(filename string, configuration interface{}) (err error) {
	...
	err = getFromFile(filename, configuration)
	if err == nil {
...
func getFromFile(filename string, configuration interface{}) (err error) {
